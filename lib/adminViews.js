...
function renderOrderDetail({ order, adminPath, message, messageType, quoteDefaults }) {
  ...
  const otherFields = [0, 1, 2].map((index) => otherItems[index] || {});
      ...
      <form method="post" action="/${adminPath}/orders/${escapeHtml(order.id)}/quote" class="grid">
        ...
        <div class="grid">
          ...
          <div class="grid two">
            <label>
              Other item 1 label
              <input type="text" name="otherLabel1" value="${escapeHtml(otherFields[0].label)}" />
            </label>
            <label>
              Other item 1 amount
              <input type="number" name="otherAmount1" step="0.01" min="0" value="${escapeHtml(otherFields[0].amount)}" />
            </label>
            <label>
              Other item 2 label
              <input type="text" name="otherLabel2" value="${escapeHtml(otherFields[1].label)}" />
            </label>
            <label>
              Other item 2 amount
              <input type="number" name="otherAmount2" step="0.01" min="0" value="${escapeHtml(otherFields[1].amount)}" />
            </label>
            <label>
              Other item 3 label
              <input type="text" name="otherLabel3" value="${escapeHtml(otherFields[2].label)}" />
            </label>
            <label>
              Other item 3 amount
              <input type="number" name="otherAmount3" step="0.01" min="0" value="${escapeHtml(otherFields[2].amount)}" />
            </label>
          </div>
        </div>
        <label>
